...
function SearchBar() {
    ...
    const SearchBarData = JSON.parse(localStorage.getItem("searchdata"))
    ...
    return (
        <div>
            <title>Search Result- Youtube</title>
            <Header />
                            ...
                            <div class="scrollbox">
                                <div class="container-md">
                                    <div class="row" style={{ marginBottom: "80px" }}>
                                        {
                                            SearchBarData.map((SearchBarData, i) =>
                                                <div>
                                                    <Link to={{ pathname: `/single_video/${SearchBarData.video_id}`, id: SearchBarData.video_id, }} onClick={setSingleVideoId(SearchBarData.video_id)} class="row mt-1 mt-sm-2" style={{ textDecoration: "none" }}>
                                                        <div class="col-6 col-md-5 col-lg-4 col-xl-3">
                                                            <img src={SearchBarData.video_thumbnail} alt='#' width="100%" className='searchbar_video_image' />
                                                        </div>
                                                        <div className='col-6 col-md-7 col-lg-8 col-xl-9'>
                                                            <h3 className='search_video_title'>{SearchBarData.video_title}</h3>
                                                            <p className='searchbar_video_details' style={{ fontSize: "16px", marginTop: "8px" }}> {SearchBarData.views} views • {SearchBarData.upload_date} </p>
                                                            <img src={SearchBarData.video_creator_profile} alt='#' style={{ width: "30px", height: "30px", borderRadius: "100%", marginRight: "10px" }} className='searchbar_video_details' />
                                                            <span className='searchbar_video_details' style={{ fontWeight: "600", fontSize: "18px" }}>
                                                                {SearchBarData.video_creator}
                                                            </span>
                                                            <h5 className='search_video_description mt-2 mt-sm-3 searchbar_video_details'>
                                                                {SearchBarData.video_description}
                                                            </h5>
                                                        </div>
                                                    </Link>
                                                </div>
