...
function SameCategoryVideo() {

    const SingleVideoId = localStorage.getItem('SameCategoryVideoId');
                                        ...
                                        SameCategoryVideoDetail.map((SameCategoryVideoDetail, i) =>
                                            <>
                                                <div className="col-5 col-md-4 col-lg-7 col-xl-6 mb-1">
                                                    <Link style={{ textDecoration: "none" }} to={{ pathname: `/single_video/${SameCategoryVideoDetail.id}`, id: SameCategoryVideoDetail.id, }} onClick={setSameCategoryVideoId(SameCategoryVideoDetail.id)}>
...
export default SameCategoryVideo;
